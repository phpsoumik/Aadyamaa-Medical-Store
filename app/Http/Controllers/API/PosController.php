            ...
            if($itemLists != NULL)
            {
                ...
                foreach($itemLists as $item)
                {
                    ...
                    $PosSubReceipt = new PosSubReceipt([
                        ...
                        'unit'        		=> $item->unit ?? 0,
                        'total_unit'        => $item->totalUnit,
                        'free_unit'   		=> $item->freeUnit ?? 0,
                        'supplier_bonus'   	=> $item->supplierBonus ?? 0,
                        'batch_no'   		=> $item->batchNo ?? '',
                        'pack_size'   		=> $item->packSize ?? 0,
                        'sheet_size'   		=> $item->sheetSize ?? 0,
                        ...
                        'product_type'   	=> $item->productType ?? '',
                        'expiry_date'   	=> $this->createDate($item->expiryDate ?? ''),
                        'item_disc'   		=> $item->cusDisc ?? 0,
                        'purchase_disc'   	=> $item->itemDisc ?? 0,
                        'after_disc'   	    => $item->purchaseAfterDisc ?? 0,
                        'tax_1'   			=> $item->tax1 ?? 0,
                        'tax_2'   			=> $item->tax2 ?? 0,
                        'tax_3'   			=> $item->tax3 ?? 0,
